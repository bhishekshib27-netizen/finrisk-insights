  ...
  return (
    <div className="mx-auto max-w-5xl px-8 sm:px-12 py-10 space-y-10">
      ...
      <div className="border-b border-neutral-200 pb-8">
        <p className="text-xs font-semibold uppercase tracking-widest text-green-600">Career Hub</p>
        ...
        <div className="mt-6 flex flex-wrap gap-3">
          ...
          <a href="mailto:hello@finriskinsight.com?subject=Post a Job on FinRisk" className="inline-flex items-center gap-2 border border-black bg-black px-3 py-1.5 text-xs font-semibold text-white transition hover:bg-neutral-800">
        ...
        {jobs.map((job) => (
          <div key={job.id} className="border border-neutral-200 bg-white p-6 transition hover:border-black hover:shadow-sm">
            <div className="flex items-start justify-between gap-4">
              ...
              <a href={job.applyUrl} target="_blank" rel="noopener noreferrer" className="shrink-0 inline-flex items-center gap-1.5 bg-black px-4 py-2 text-xs font-semibold text-white transition hover:bg-neutral-800">
      ...
      <div className="border border-neutral-200 bg-neutral-50 p-8 text-center">
        ...
        <a href="mailto:hello@finriskinsight.com?subject=Post a Job on FinRisk" className="mt-4 inline-flex items-center gap-2 bg-black px-5 py-2.5 text-sm font-semibold text-white transition hover:bg-neutral-800">
