  ...
  return (
    <div className="mx-auto max-w-5xl px-8 sm:px-12 py-10 space-y-10">
      ...
      <div className="border border-neutral-200 bg-neutral-50 p-10 text-center space-y-4">
        ...
        <a href="/newsletter" className="inline-flex items-center gap-2 bg-black px-5 py-2.5 text-sm font-semibold text-white transition hover:bg-neutral-800">
          Notify me at launch
        </a>
      </div>
      ...
      <div className="border border-neutral-200 bg-white p-8">
        ...
        <a href="mailto:hello@finriskinsight.com?subject=FinRisk Podcast Guest" className="inline-flex items-center gap-2 border border-black px-4 py-2 text-sm font-semibold text-black transition hover:bg-black hover:text-white">
