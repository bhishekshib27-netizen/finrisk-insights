      ...
      <div className="mx-auto max-w-7xl px-6 py-12">
        <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-5">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="mt-6">
              <a href="https://www.linkedin.com/company/finrisk-insights" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 border border-neutral-200 px-3 py-2 text-xs font-semibold text-neutral-500 transition hover:border-black hover:text-black">
